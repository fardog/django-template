# Django settings for APP_TEMPLATE_NAME project.
...
PIPELINE_JS = {
    'APP_TEMPLATE_NAME_global_js': {
        ...
        'output_filename': 'javascripts/APP_TEMPLATE_NAME_global.min.js',
    },
    'modernizr_js': {
        'source_filenames': (
...
ROOT_URLCONF = 'APP_TEMPLATE_NAME.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'APP_TEMPLATE_NAME.wsgi.application'
